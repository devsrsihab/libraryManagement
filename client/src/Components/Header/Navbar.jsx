...
<header className={`${theme === 'light' ? 'text-slate-700' : 'text-white'}  container relative mx-auto flex flex-col overflow-hidden px-4 py-4 lg:flex-row lg:overflow-visible lg:items-center`}>
  <Link
    to='/'
    className="flex items-center whitespace-nowrap text-2xl font-black"
  >
    <span className="mr-2 w-12-">
      <img className="w-full h-full object-cover" src="https://i.ibb.co/qpGgxkp/bookstor-compact-MConverter-eu.png" alt="" />
    </span>
  </Link>
              ...
              <>
              {
                ...
                <li className="ml-6 flex h-8 w-8 cursor-pointer items-center justify-center rounded-xl border text-gray-600 hover:text-black hover:shadow">
                  ...
                  <details className="dropdown">
                    ...
                    <ul
                      style={{ right: "-55%" }}
                      className={`p-2  w-80 shadow absolute ${theme === 'light' ? 'bg-primary  text-white' : 'bg-black text-white border'}  menu dropdown-content z-[1] rounded-box `}
                    >
                      <li>
